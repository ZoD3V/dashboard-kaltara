...
type NeracaPoint = { period: string; value: number };
...
export default function KaltaraMap() {
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            document.querySelectorAll<HTMLElement>('.callout').forEach((card) => {
                ...
                // titik start = sisi card terdekat dgn anchor
                ...
                // offset kecil agar tak menutupi dot
                const dx = e.x - s.x,
                    dy = e.y - s.y,
    ...
    useEffect(() => {
        ...
        const onClick = (e: any) => {
            ...
            // mapkan ke union RegionName sebisanya
    ...
    return (
        <section className='mx-auto flex w-full flex-col items-center justify-center px-4 py-24'>
            ...
            <div
                ...
                <div className='w-[350px] sm:w-[550px] xl:w-[615px]'>
                    ...
                    <svg
                        ...
                        <path
                            id='malinau'
                            className='region fill-emerald-400 transition hover:brightness-95'
                        ...
                        <path
                            id='bulungan'
                            className='region fill-amber-400 transition hover:brightness-95'
                        ...
                        <path
                            id='tana-tidung'
                            className='region fill-orange-400 transition hover:brightness-95'
                        ...
                        <path
                            id='tarakan'
                            className='region fill-rose-500 transition hover:brightness-95'
                            ...
                            <div className='flex items-start gap-2 rounded-xl border border-slate-300 bg-white px-4 py-3 lg:gap-4 lg:px-6'>
                                ...
                                <div className='flex flex-col'>
                                    ...
                                    <div className='mt-1 text-xl font-bold lg:text-2xl'>
                                        {region.ton} <span className='text-base font-bold'>ton</span>
                                    </div>
                                    <div
                                        className={`mt-2 inline-flex w-fit items-center gap-1 rounded-full px-2 py-1 text-xs font-semibold ${region.statusColor}`}>
                                        {region.status}
                                    </div>
                                </div>
                            </div>
            ...
            <div className='mt-8 p-4 md:p-6'>
                ...
                <div className='flex max-w-[1440px] items-start gap-2 p-3 text-xs text-gray-700 md:p-4 md:text-sm'>
                    ...
                    <div>
                        ...
                        <p className='leading-relaxed text-slate-600'>
                            ...
                            ketersediaandengan kebutuhan) dibagi dengan kebutuhan selama satu bulan dengan klasifikasi
                            threshold sebagaimana dibawah.
                        </p>
                    </div>
                </div>
            </div>
