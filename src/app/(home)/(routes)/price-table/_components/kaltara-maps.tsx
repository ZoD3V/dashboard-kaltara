...
type KaltaraMapProps = {
    activeTab: PriceType;
    selectedCommodity: string;
    selectedPriceType: string; // ganti dengan type kamu
};

const KaltaraMap: React.FC<KaltaraMapProps> = ({ activeTab, selectedCommodity, selectedPriceType }) => {
